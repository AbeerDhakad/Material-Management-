...
def EditDeleteRecord(request):
    ...
    if(btn=="Edit"):
     ...
     try:
        db, cmd = Pool.ConnectionPool()
        q = "update employee set firstname='{}', lastname='{}', gender='{}', dob='{}', paddress='{}', stateid={}, cityid={},graduation={},course={} ,caddress='{}', email='{}', mobileno='{}', designation='{}' where employeeid={}".format(firstname, lastname, gender, birthdate, paddress, state, city,gr,course, caddress, emailaddress, mobilenumber,designation,empid)
        print (q)
        cmd.execute(q)
        db.commit()
        db.close()
